...
import { Bars3Icon, XMarkIcon, DocumentTextIcon, ChatBubbleLeftRightIcon, Cog6ToothIcon } from '@heroicons/react/24/outline';
...
export default function Navbar() {
  ...
  const isActive = (path: string) => {
    return pathname === path ? 'bg-[#01f6d2] text-black' : 'text-gray-700 hover:bg-[#01f6d2] hover:text-black';
  };
          ...
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <Link href="/" className="flex items-center">
                <span className="text-[#01f6d2] font-bold text-xl">RAG Playground</span>
              </Link>
            </div>
